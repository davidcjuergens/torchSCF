...
def run_scf(mol, maxiter: int = 100, etol: float = 1e-6, ptol: float = 1e-6):
    ...
    """
    # (1) specifying nuclear coordinates, atomic numbers and basis set done elsewhere

    # (2) compute molecular integrals
    S, Hcore, two_e_integrals = compute_integrals(mol)
